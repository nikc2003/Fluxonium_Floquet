General simulations within the Floquet framework.  
Includes Xiao and branch analysis to:
  1. evaluate onset of hybridization for state in computational manifold 
